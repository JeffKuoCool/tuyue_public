...
//    try {
      ...
      val contentArray =
        TfLiteImageUtils.bitmapToByteBuffer(contentImage, CONTENT_IMAGE_SIZE, CONTENT_IMAGE_SIZE)
      val styleBitmap = BitmapFactory.decodeFile(stylePath)
      val input = TfLiteImageUtils.bitmapToByteBuffer(styleBitmap, STYLE_IMAGE_SIZE, STYLE_IMAGE_SIZE)
      ...
      var styledImage =
        TfLiteImageUtils.convertArrayToBitmap(outputImage, CONTENT_IMAGE_SIZE, CONTENT_IMAGE_SIZE)
